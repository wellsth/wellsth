...
<meta name="by-chafenba-com" content="25e33d7fc3430f206f1b12d1e38cb6db" />
...
<link href="inc/css/style.css?v=V190828_09525134Z&t=170828" rel="stylesheet" type="text/css" />
<script type="text/javascript" src="inc/js/js.js?v=V190828_09525134Z&t=170828"></script>
</head>
<body onLoad="inst();">
<div class="html">
...
if(!$shujus){
 ...
 //index.php?t=190828@5d65de73d3231&m=11c70f2ec66f004bd878dcedec867af2 
?>
<form name="queryForm" method="post" action="?t=<?php echo $tts;?>" onsubmit="return Check34Z(0);">
<div class="select" id="10">
<select name="time" id="time" onBlur="Check34Z(1)" >
<?php traverse($UpDir."/",$dbtype);?></select></div>
<div class="so_box" id="11">
<input name="name" type="text" class="txts" id="name" value="" placeholder="请输入<?php echo $tiaojian1;?>" onfocus="st('name',1)" onBlur="Check34Z(2)" />
</div>
<?php
if($ismas=="1"){
?>
<div class="so_box" id="33">
<input name="code" type="text" class="txts" id="code" placeholder="请输入验证码" onfocus="this.value=''" onBlur="Check34Z(3)" />
...
echo '<tr>';
$line1tou =$tabvt["$iag"];
echo '<td class=r>'.$line1tou.'</td>';
echo '<td class=l>'.$tabu.'</td>';
echo '</tr>';
}
echo '</table>';
}
